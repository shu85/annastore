...
var __parent0=require('$model/UI2/AnnaStore/index'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cq2auAr';
	this._flag_='6f33fd4b60f9e2d90dae48c09796cffc';
	this._wCfg_={};
	this._appCfg_={};
	this.callParent(contextUrl);
 var __BaasData__ = require("$UI/system/components/justep/data/baasData");new __BaasData__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"iDescript":{"define":"iDescript","label":"iDescript","name":"iDescript","relation":"iDescript","type":"String"},"iId":{"define":"iId","label":"iId","name":"iId","relation":"iId","type":"String"},"iImage":{"define":"iImage","label":"iImage","name":"iImage","relation":"iImage","type":"String"},"iName":{"define":"iName","label":"iName","name":"iName","relation":"iName","type":"String"},"iPrice":{"define":"iPrice","label":"iPrice","name":"iPrice","relation":"iPrice","rules":{"number":true},"type":"Decimal"}},"directDelete":false,"events":{},"idColumn":"iId","isMain":false,"limit":20,"queryAction":"queryIstore","saveAction":"saveIstore","tableName":"istore","url":"/cstore/annastore","xid":"baasData1"});
}}); 
return __result;});
